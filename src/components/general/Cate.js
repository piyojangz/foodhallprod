...
class Cate extends Component {
  ...
  renderblank = () => {
    console.log('blank', this.state.items.length);
    ...
    if (i == 0) {
      ...
      return (
        ...
        <View style={{ backgroundColor: '#fff', borderBottomColor: '#ECF0F1', borderBottomWidth: 1 }}>
          <TouchableWithoutFeedback onPress={() => this.onItemClicked(data)} >
            <View>
              <View style={{ padding: 15, paddingBottom: 8, marginTop: 8, }}><Text style={{ color: '#464646', fontSize: 18, fontWeight: 'bold', textAlign: 'left' }}>{data.shopdetail.title}</Text></View>
