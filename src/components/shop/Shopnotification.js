...
/* Component ==================================================================== */
class Shopnotification extends Component {
  ...
  async _loadInitialDataAsync() {
    ...
    let response = await fetch(AppConfig.api + 'api/getdonenotification', request);
...
export default connect(mapStateToProps, mapDispatchToProps)(Shopnotification);
